...
export default function Home() {
  ...
  const isCheckedIn = usePosStore((state) => state.isCheckedIn);
  const checkedInEmployee = usePosStore((state) => state.checkedInEmployee);
  const checkOutEmployee = usePosStore((state) => state.checkOutEmployee);
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to check out? This will end your current
              session and return you to the check-in screen.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

          ...
          <div className="flex items-center gap-3 mt-4">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="shrink-0">
              <TabsList className="h-8 p-0.5 bg-muted/60">
                <TabsTrigger value="all" className="h-7 px-3 text-xs font-medium">All</TabsTrigger>
                <TabsTrigger value="unread" className="h-7 px-3 text-xs font-medium">Unread</TabsTrigger>
                <TabsTrigger value="sales" className="h-7 px-3 text-xs font-medium">Sales</TabsTrigger>
                <TabsTrigger value="alerts" className="h-7 px-3 text-xs font-medium">Alerts</TabsTrigger>
              </TabsList>
            </Tabs>

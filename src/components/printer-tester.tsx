    ...
    <div className="p-4 max-w-md mx-auto border rounded shadow">
      ...
      {method === 'network' && (
        <div className="mb-4">
          ...
          <input 
            ...
            className="w-full p-2 border rounded" placeholder="192.168.x.x"
          />
        </div>
      )}
      ...
      {method === 'system' && (
        <div className="mb-4">
          ...
          <input 
            type="text" value={printerName} onChange={e => setPrinterName(e.target.value)} 
            className="w-full p-2 border rounded" placeholder="Name in Settings"
          />
        </div>
      )}
      ...
      {method === 'usb' && (
        <div className="flex gap-2 mb-4">
          <div>
            ...
            <input type="text" value={vid} onChange={e => setVid(e.target.value)} className="w-full p-2 border rounded" />
          </div>
          <div>
            <label className="block text-sm">PID (Hex)</label>
            <input type="text" value={pid} onChange={e => setPid(e.target.value)} className="w-full p-2 border rounded" />
          </div>
        </div>
      )}
